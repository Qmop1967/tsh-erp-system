...
import { SalesInvoice, InvoiceStatusEnum } from '../../types';
import { getAllSalesInvoices, invoiceApi } from '../../lib/api';
import CreateSalesInvoiceModal from '../../components/invoices/CreateSalesInvoiceModal';
...
const SalesInvoicesPage: React.FC = () => {
  ...
  const filteredInvoices = invoices.filter(invoice =>
    ...
    invoice.customer?.nameEn?.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const handleDelete = async (invoice: SalesInvoice) => {
    if (window.confirm(`Are you sure you want to delete invoice ${invoice.invoice_number}?`)) {
      try {
        await invoiceApi.deleteSalesInvoice(invoice.id);
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {filteredInvoices.length === 0 && (
          <div className="text-center py-12">
            <div className="text-gray-500">No sales invoices found</div>
          </div>
        )}
