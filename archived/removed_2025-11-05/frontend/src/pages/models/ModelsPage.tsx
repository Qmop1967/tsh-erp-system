...
interface DatabaseModel {
  ...
  record_count?: number
  category: 'core' | 'inventory' | 'sales' | 'purchasing' | 'accounting' | 'pos' | 'cashflow' | 'expenses' | 'other'
}
...
export function ModelsPage() {
  ...
  const categories = [
    ...
    { value: 'expenses', label: 'Expenses', count: models.filter(m => m.category === 'expenses').length },
