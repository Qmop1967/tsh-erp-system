...
class AnnouncementCreate(BaseModel):
    ...
    target_branches: Optional[List[int]] = None
...
class AnnouncementResponse(BaseModel):
    ...
    target_branches: Optional[List[int]]
    is_pinned: bool
    priority: int
...
class EmergencyBroadcastCreate(BaseModel):
    """Schema for creating emergency broadcast"""
...
class TopicSubscriptionUpdate(BaseModel):
    """Schema for updating topic subscription"""
...
class ScheduledNotificationCreate(BaseModel):
    """Schema for creating scheduled notification"""

    name: str = Field(..., max_length=255)
    description: Optional[str] = None
    notification_template: Dict[str, Any] = Field(...)
    target_roles: Optional[List[str]] = None
    target_branches: Optional[List[int]] = None
    target_users: Optional[List[int]] = None
