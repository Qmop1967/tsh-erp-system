"""
Zoho Sync Queue Service (Moved to TDS)
=======================================
...
**NEW LOCATION:** app/tds/integrations/zoho/queue.py
**OLD LOCATION:** app/services/zoho_queue.py (DEPRECATED)
...
class ZohoQueueService:
    """
    Zoho Queue Service for TDS Sync Queue Management

    خدمة قائمة انتظار Zoho لإدارة قائمة انتظار TDS
...
QueueService = ZohoQueueService

__all__ = ["ZohoQueueService", "QueueService"]
